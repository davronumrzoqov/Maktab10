...
@section('content')
    ...
    <style>
        ...
        .card {
            ...
            animation: slideIn 0.6s ease; /* kirish animatsiyasi */
        }
    ...
    <div class="create-category-wrapper">
        <form action="{{ route('admin.CategoryTop.store') }}" method="POST" style="width: 100%; max-width: 550px;">
            @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('name_uz') is-invalid @enderror"
                               id="name_uz" placeholder="Bo‘lim nomi (UZ)" name="name_uz" value="{{ old('name_uz') }}">
                        @error('name_uz')
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('name_ru') is-invalid @enderror"
                               id="name_ru" placeholder="Название (RU)" name="name_ru" value="{{ old('name_ru') }}">
                        @error('name_ru')
                        <div class="invalid-feedback" style="color: red;">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control @error('url') is-invalid @enderror"
                               id="url" placeholder="/path..." name="url" value="{{ old('url') }}">
                        @error('url')
                        <div class="invalid-feedback" style="color: red;">{{ $message }}</div>
                        @enderror
                    </div>
